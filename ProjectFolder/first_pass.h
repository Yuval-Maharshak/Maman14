...
* @param commandTable an empty word list to be filled with commands.
* @param dataTable an empty word list to be filled with data.
...
*/
bool first_pass(FILE *src, wordList *commandTable, wordList *dataTable, table_head *head, extList *extlst);
...
* @param dataTable Points to the data table
...
* into the data table.
* @param dataTable Pointer to data table.
