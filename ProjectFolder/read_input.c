...
/*
    ...
    translate(tranlating commandTable and dataTable to 32-base and printing it on screen).
*/
void assembler(char *fileName)
 {
    ...
    wordList commandTable = {NULL, NULL};
    wordList dataTable = {NULL, NULL};

    table_head head;

    extList ext_lst = {NULL};
    ...
    passWorked = first_pass(expanded, &commandTable, &dataTable, &head, &ext_lst);
    ...
    passWorked = second_pass(expanded, &commandTable, &head, &ext_lst, ent, ext);
    ...
    translate(commandTable, dataTable, fileName); 
    
    printf("Process completed.\nGood Bye..\n\n");

    freeList(commandTable);
    freeList(dataTable);
